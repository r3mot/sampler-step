 ...
 * @param {*} samples - The samples to be used in the sequence
 */
export const initSamplers = (samples: any) => {
 ...
 */
export const initSequence = (samplers: any, steps: any, numBeats: any) => {
  return new Tone.Sequence(
    (time, step) => {
      samplers.current.map((sample: any) => {
 ...
 */
const showSteps = (steps: any, step: any) => {
